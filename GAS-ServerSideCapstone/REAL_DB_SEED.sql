...
VALUES (1, 'Guitar'), (2, 'Bass'), (3, 'Drums'), (4, 'Recording'), (5, 'Keys/Synth'), (6, 'Live Sound'), (7, 'Amp'), (8, 'Pedal'), (9, 'Acoustic Instrument');
...
insert into [Item] ([Id], [UserId], [CategoryId], [Title], [Description], [IsForSale], [SalePrice], [ImageUrl]) values (2, 3, 7, 'Crate GT212', '120 Watt Combo Amp. Do not H8 the Cr8', 1, '2000', 'https://images.reverb.com/image/upload/s--RclooOh4--/t_card-square/v1568637603/mz9lk39capetodj4idn1.jpg');
...
insert into [Item] ([Id], [UserId], [CategoryId], [Title], [Description], [IsForSale], [SalePrice], [ImageUrl]) values (4, 3, 3, 'Slingerland Drum Kit', '1968 Brown Vintage Kit. Normal wear and tear on an older kit', 0, NULL, 'https://www.vintagedrum.com/wp-content/uploads/2016/04/VI-2936-Sling-4pc-mahog.jpg');
insert into [Item] ([Id], [UserId], [CategoryId], [Title], [Description], [IsForSale], [SalePrice], [ImageUrl]) values (5, 1, 1, 'Gibson SG', '1969 Vintage SG. Normal wear and tear on an older guitar', 0, NULL, 'https://i.ebayimg.com/images/g/9XYAAOSwe8ldEla9/s-l300.jpg');
insert into [Item] ([Id], [UserId], [CategoryId], [Title], [Description], [IsForSale], [SalePrice], [ImageUrl]) values (6, 4, 1, 'Gibson Firebird', '1965 Vintage Firebird. Normal wear and tear on an older guitar', 0, NULL, 'https://www.vintageandrare.com/uploads/products/43180/1650512/big.jpg');
...
insert into [Comment] ([Id], [ItemId], [UserId], [Title], [Description]) values (7, 2, 2, 'Trades for Amp?', 'Guess it was not meant to be. Good luck!');
insert into [Comment] ([Id], [ItemId], [UserId], [Title], [Description]) values (8, 2, 1, 'Trades for Amp?', 'I have a 1968 Princeton Reverb Reissue.'); 
